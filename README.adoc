...
* [x] make sizing buttons a popup
* [x] convert layouts to constraintlayout
* [ ] add reset button to piano view
* [ ] add nice app icon
* [x] top of keys needs a black border, too
* [ ] label too high in horizontal mode
* [x] update about-tonality.html
* [x] strip unneeded semitone assets

.Tonality as of 2019-05-26
image::doc/tonality-v0.2-dev.png[]
